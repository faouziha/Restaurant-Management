...
// Define the waiter type for your props
interface Waiter {
    id: number;
    name: string;
}
...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Create Table', href: '/tables/create' }
];

export default function Create({ waiters }: Props) { // Added waiters prop
            ...
            <AppLayout breadcrumbs={breadcrumbs}>
                ...
                <div className="flex flex-col items-center justify-center flex-1 h-full gap-6 mt-20 md:mt-32">
                    ...
                    <p className="text-muted-foreground">
                        Table number {data.number} has been created and is ready for service.
                    </p>
